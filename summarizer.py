...
from SemanticRoleModelling import semanticRoleModeller
...
class summary(object):
    ...
    Attributes:
        event: A string representing the event captured from semanticRoleModeller
    ...
    headers = {
        # Request headers
        'Ocp-Apim-Subscription-Key': '2826fdb6db204a12ae89be9ed9ca5296',
    }
